...
export default function PuspaModalOTPPassword({ isOpen, onClose, old_password, new_password }) {
  const { handleSuccess, handleError } = useAlert();
  const { otpPasswordVerifyApi } = useApiAuthCalls();
  ...
  const handleVerifyClick = async (e) => {
    ...
    await otpPasswordVerifyApi({ id: user.user._id,otp, old_password, new_password })
      .then((data) => {
        // console.log(data);
...
PuspaModalOTPPassword.propTypes = {
